...
## Оглавление  
[1. Описание проекта](https://www.kaggle.com/competitions/sf-booking/overviewHunter/README.md#Описание-проекта)  
...
[3. Краткая информация о данных](https://www.kaggle.com/competitions/sf-booking/data#Краткая-информация-о-данных:)  
